package org.bcschain.wallet.dataprovider.services.update_service;
...
import org.bcschain.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.bcschain.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.bcschain.wallet.model.gson.history.HistoryResponse;
...
import org.bcschain.wallet.utils.BoughtContractBuilder;

import org.bcschain.wallet.R;
import org.bcschain.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.bcschain.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.bcschain.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import org.bcschain.wallet.utils.CurrentNetParams;
import org.bcschain.wallet.utils.DateCalculator;
import org.bcschain.wallet.utils.BCSIntent;
...
import static org.bcschain.wallet.WearListCallListenerService.ADDRESS;
import static org.bcschain.wallet.WearListCallListenerService.BALANCE;
import static org.bcschain.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.bcschain.wallet.WearListCallListenerService.ITEMS;
import static org.bcschain.wallet.WearListCallListenerService.UNC_BALANCE;
import static org.bcschain.wallet.utils.StringUtils.convertBalanceToString;
