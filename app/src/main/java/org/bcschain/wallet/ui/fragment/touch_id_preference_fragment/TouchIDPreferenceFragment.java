...
public abstract class TouchIDPreferenceFragment extends BaseFragment implements TouchIDPreferenceView {
    ...
    @OnClick({org.bcschain.wallet.R.id.bt_enable_touch_id, org.bcschain.wallet.R.id.bt_not_now})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.bcschain.wallet.R.id.bt_enable_touch_id:
                getPresenter().onEnableTouchIdClick();
            case org.bcschain.wallet.R.id.bt_not_now:
                if (!mIsImporting) {
