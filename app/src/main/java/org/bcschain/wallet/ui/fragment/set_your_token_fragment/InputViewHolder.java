...
import org.bcschain.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.bcschain.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.bcschain.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.bcschain.wallet.R.id.checkbox)
