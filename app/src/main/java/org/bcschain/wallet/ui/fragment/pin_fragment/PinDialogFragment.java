...
import org.bcschain.wallet.utils.PinEntryEditText;
...
public class PinDialogFragment extends DialogFragment {
    ...
    @BindView(org.bcschain.wallet.R.id.til_wallet_pin)
    PinEntryEditText mWalletPin;

    @BindView(org.bcschain.wallet.R.id.tv_toolbar_title)
    FontTextView mTextViewToolBarTitle;

    @BindView(org.bcschain.wallet.R.id.tooltip)
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.bcschain.wallet.R.layout.dialog_fragment_pin : org.bcschain.wallet.R.layout.dialog_fragment_pin_light, null);
            ...
            ((MainActivity) getActivity()).checkSensorState(new MainActivity.SensorStateListener() {
                ...
                public void onRequest(MainActivity.SensorState sensorState) {
                    if (sensorState == MainActivity.SensorState.READY) {
                        mTextViewToolBarTitle.setText(org.bcschain.wallet.R.string.confirm_fingerprint_or_pin);
                        prepareSensor();
                    } else {
                        mTextViewToolBarTitle.setText(org.bcschain.wallet.R.string.enter_pin);
                    }
                }
            });
        } else {
    ...
    private void confirmError(String errorText) {
        if (getDialog() != null) {
            ...
            tooltip.setTextColor(ContextCompat.getColor(getContext(), org.bcschain.wallet.R.color.accent_red_color));
    ...
    private void confirm(String pin) {
        ...
        if (isCorrect) {
            ...
            confirmError(getContext().getString(org.bcschain.wallet.R.string.incorrect_pin));
        }
    }
