...
public class NewsPresenterImpl extends BaseFragmentPresenterImpl implements NewsPresenter {
    ...
    public void onRefresh() {
        if (mNetworkConnectedFlag) {
            ...
            getView().setAlertDialog(org.bcschain.wallet.R.string.no_internet_connection,
                    org.bcschain.wallet.R.string.please_check_your_network_settings,
                    org.bcschain.wallet.R.string.ok,
