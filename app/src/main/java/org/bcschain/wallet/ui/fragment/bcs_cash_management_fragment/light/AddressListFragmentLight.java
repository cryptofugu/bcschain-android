package org.bcschain.wallet.ui.fragment.bcs_cash_management_fragment.light;
...
import org.bcschain.wallet.ui.fragment.bcs_cash_management_fragment.AddressesWithBalanceAdapter;
import org.bcschain.wallet.ui.fragment.bcs_cash_management_fragment.AddressesWithBalanceSpinnerAdapter;
    ...
    protected void showTransferDialogFragment(final AddressWithBalance keyWithBalanceTo, List<AddressWithBalance> keyWithBalanceList) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                tvBalanceFrom.setText(String.format("%s BCS", balance.toString()));
            }
