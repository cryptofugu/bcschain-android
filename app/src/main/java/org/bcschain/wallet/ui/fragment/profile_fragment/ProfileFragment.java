...
import org.bcschain.wallet.ui.fragment.about_fragment.AboutFragment;
import org.bcschain.wallet.ui.fragment.language_fragment.LanguageFragment;
...
import org.bcschain.wallet.ui.fragment.subscribe_tokens_fragment.SubscribeTokensFragment;
...
import static org.bcschain.wallet.ui.fragment.pin_fragment.PinAction.AUTHENTICATION_FOR_PASSPHRASE;
import static org.bcschain.wallet.ui.fragment.pin_fragment.PinAction.CHANGING;
...
public abstract class ProfileFragment extends BaseNavFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(org.bcschain.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            ...
            case org.bcschain.wallet.R.string.log_out:
                ...
                break;
            case org.bcschain.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case org.bcschain.wallet.R.string.touch_id:
