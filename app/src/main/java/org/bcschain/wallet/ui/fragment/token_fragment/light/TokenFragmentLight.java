package org.bcschain.wallet.ui.fragment.token_fragment.light;
...
import org.bcschain.wallet.ui.fragment.token_fragment.dark.TokenHistoryAdapterDark;
...
public class TokenFragmentLight extends TokenFragment {
    ...
    private final int LAYOUT = org.bcschain.wallet.R.layout.lyt_token_fragment_light;

    @BindView(org.bcschain.wallet.R.id.wave_view)
    WaveView waveView;
    private WaveHelper mWaveHelper;

    @BindView(org.bcschain.wallet.R.id.bt_share)
    ImageButton mShareBtn;

    @BindView(org.bcschain.wallet.R.id.iv_choose_address)
    ImageView mIvChooseAddress;

    @BindView(org.bcschain.wallet.R.id.tv_token_name)
