...
import org.bcschain.wallet.utils.SearchBar;
import org.bcschain.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(org.bcschain.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(org.bcschain.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(org.bcschain.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(org.bcschain.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(org.bcschain.wallet.R.id.tv_single_string)
        TextView mTextViewCurrency;
        @BindView(org.bcschain.wallet.R.id.iv_check_indicator_blue)
        ImageView mImageViewCheckIndicator;
        @BindView(org.bcschain.wallet.R.id.ll_single_item)
