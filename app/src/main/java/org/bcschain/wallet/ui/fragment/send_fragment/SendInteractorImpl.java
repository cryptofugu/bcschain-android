        ...
        getUnspentOutputs(from, new GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(mContext.getString(org.bcschain.wallet.R.string.invalid_bcs_address));
                    return;
                }
                ...
                if (overFlow.doubleValue() < amount.doubleValue()) {
                    callBack.onError(mContext.getString(org.bcschain.wallet.R.string.you_have_insufficient_funds_for_this_transaction));
                    return;
                }
                ...
                if (minimumFee.doubleValue() > fee.doubleValue()) {
                    callBack.onError(mContext.getString(R.string.insufficient_fee_lease_use_minimum_of) + " " + minimumFee.toString() + " BCS");
                    return;
                }
