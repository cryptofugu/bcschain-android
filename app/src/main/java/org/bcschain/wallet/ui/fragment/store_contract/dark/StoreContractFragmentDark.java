package org.bcschain.wallet.ui.fragment.store_contract.dark;
...
public class StoreContractFragmentDark extends StoreContractFragment {
    ...
    protected int getLayout() {
        return org.bcschain.wallet.R.layout.lyt_store_contract;
    }

    @OnClick(org.bcschain.wallet.R.id.tv_view_abi)
    ...
    public void setContractData(QstoreContract contract) {
        ...
        rvTags.setAdapter(new TagRecyclerViewAdapter(contract.tags, this, org.bcschain.wallet.R.layout.item_tag));
