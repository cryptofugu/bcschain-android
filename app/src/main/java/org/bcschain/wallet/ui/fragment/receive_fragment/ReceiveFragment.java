package org.bcschain.wallet.ui.fragment.receive_fragment;
...
import org.bcschain.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "BCS QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "BCS QR-Code"));
        }
    }
