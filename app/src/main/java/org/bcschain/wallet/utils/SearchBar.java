...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.bcschain.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.bcschain.wallet.R.id.text);
        input = (EditText) findViewById(org.bcschain.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.bcschain.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.bcschain.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.bcschain.wallet.R.id.bt_clear_search);
