...
public class FontTextInputEditText extends TextInputEditText {
    ...
    public FontTextInputEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, org.bcschain.wallet.R.styleable.FontTextInputEditText);

        if (ta != null) {
            String fontAsset = ta.getString(org.bcschain.wallet.R.styleable.FontTextInputEditText_inputTypeface);
